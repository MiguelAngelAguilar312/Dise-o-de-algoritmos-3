...
for (let multipliacion=0;multipliacion<numeros.length;multipliacion++){
    resultado.push (numeros [multipliacion]*2);
    console.log("El resultado es: " + resultado[multipliacion]);
}
